...
function update(...)
    ...
    local altHand = player.getProperty("js_altHand", {})
    local primaryHand = player.getProperty("js_primaryHand", {})
    ...
    player.setProperty("js_altHand", {})
    player.setProperty("js_primaryHand", {})
end